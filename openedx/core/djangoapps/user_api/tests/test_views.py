...
class RegistrationViewValidationErrorTest(ThirdPartyAuthTestMixin, UserAPITestCase, RetirementTestCase):
    ...
    def test_register_duplicate_retired_username_account_validation_error(self):
        ...
        with mock.patch('openedx.core.djangoapps.user_authn.views.register.do_create_account') as dummy_do_create_account:
            # do_create_account should *not* be called - the duplicate retired username should be detected before it's called.
            dummy_do_create_account.side_effect = Exception('do_create_account should *not* have been called!')
